  <!-- add new calendar event modal -->
        ...
        <!-- jQuery UI 1.10.3 -->
        <script src="<?php echo base_url() ?>/public/admin/js/jquery-ui-1.10.3.min.js" type="text/javascript"></script>
        <!-- Bootstrap -->
        ...
        <!-- fullCalendar -->
        <script src="<?php echo base_url() ?>/public/admin/js/plugins/fullcalendar/fullcalendar.min.js" type="text/javascript"></script>
        <!-- jQuery Knob Chart -->
        ...
        <script src="<?php echo base_url() ?>/public/admin/js/AdminLTE/demo.js" type="text/javascript"></script>
           ...
           <!-- bootstrap-growl -->
        <script src="<?php echo base_url() ?>/public/admin/js/plugins/bootstrap-growl/bootstrap-growl.js" type="text/javascript"></script>
