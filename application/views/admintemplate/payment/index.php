                ...
                <div class="box box-body" id="loading-example">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    <th><strong>ลำดับที่</strong></th>
                                    <th><strong>เลขที่ใบสั่งซื้อ</strong></th>
                                    <th><strong>ชำระเงินเข้าบัญชี</strong></th>
                                    ...
                                    <th><strong>อีเมลล์</strong></th>
                                    <th><strong>ข้อมูล</strong></th>
