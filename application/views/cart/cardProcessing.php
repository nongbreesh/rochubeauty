...
<?php $message_cust .= "<tr><td width='200'>".$item['name']."</td>
    ...
    <?php $_SESSION['total'] += $item['qty'] * $item['price']; } ?>
  <?php 
  ...
  <?php $message_cust .= "<table width='100%'".$_SESSION['SHOPPING_CART_HTML'] = ob_get_flush()."
			<tr>
      ...
      <p>
<table><tr><td>
        <p><img alt="" src="http://www.magazinedee.com/share/images/icon_payment_kbank.gif" />  ธนาคาร กสิกรไทย  ประเภท ออมทรัพย์ สาขาเซ็นทรัลรามอินทรา  ชื่อบัญชี วีระยุทธ ตะสูงเนิน   เลขที่บัญชี 797-2083-636</p>
     <p><img alt="" src="http://www.messagedd.com/th/images-2009/bangkok_bank.png" /> ธนาคาร กรุงเทพ  ประเภท ออมทรัพย์  สาขาเซ็นทรัลรามอินทร ชื่อบัญชี วีระยุทธ ตะสูงเนิน  เลขที่บัญชี 930-0057-123 </p>
							  		<p><img alt="" src="http://www.vongvisit.com/private_folder/scb.png" />  ธนาคาร ไทยพานิช  ประเภท ออมทรัพย์ สาขาอินเตอร์เชนจ 21 (สุขุมวิทย์) ชื่อบัญชี วีระยุทธ ตะสูงเนิน  เลขที่บัญชี 196-2065-249</p>
	</td></tr></table></p>
	';
   ...
   $this->_email->sendinfo($message_cust,$this->input->post('txt_email'),'Confirm Order ขายน้ำมันมะพร้าว.com #'.$order_id);
   $this->_email->sendinfo($message_cust,'breesh.comsci@gmail.com','คุณมี Order จาก ขายน้ำมันมะพร้าว.com #'.$order_id);
...
<?php $message_s .= "<tr><td width='200'>".$item['name']."</td>
 ...
 <p><img src="http://www.magazinedee.com/share/images/icon_payment_kbank.gif "  />  ธนาคาร กสิกรไทย  ประเภท ออมทรัพย์ สาขาเซ็นทรัลรามอินทรา  ชื่อบัญชี วีระยุทธ ตะสูงเนิน   เลขที่บัญชี 797-2083-636</p>
     <p><img alt="" src="http://www.messagedd.com/th/images-2009/bangkok_bank.png" /> ธนาคาร กรุงเทพ  ประเภท ออมทรัพย์  สาขาเซ็นทรัลรามอินทร ชื่อบัญชี วีระยุทธ ตะสูงเนิน  เลขที่บัญชี 930-0057-123 </p>
							  		<p><img alt="" src="http://www.vongvisit.com/private_folder/scb.png" />  ธนาคาร ไทยพานิช  ประเภท ออมทรัพย์ สาขาอินเตอร์เชนจ 21 (สุขุมวิทย์) ชื่อบัญชี วีระยุทธ ตะสูงเนิน  เลขที่บัญชี 196-2065-249</p>
...
<table width="100%" class="display_basket" cellpadding="0" cellspacing="0">
<tr >
<td style="padding:2px; background:#333333;" align="center">Copyright by ขายน้ำมันมะพร้าว.com © 2013-2014 - All Rights Reserved</td>
