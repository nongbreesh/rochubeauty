...
$id = $_GET["id"]; 
$account = $db->single("SELECT detail FROM  announced  WHERE id = '1' ");


if(!empty($_POST['btn_update'])){
$sql = "UPDATE announced SET ";
$sql = $sql."detail = '".$_POST['txt_desc']."' ";
$sql = $sql."WHERE id = '1'"; 
$db->execute($sql);
echo"<script>location.href='shop_setting.php'</script>";
}
...
<form id="form1" name="form1" method="post" action="">
  <table width="90%" border="0" cellspacing="0" cellpadding="0" class="MyHTML">
    <tr >
      <td colspan="2" class="head"><strong>ข้อFooter</strong></td>
    </tr>
    <tr>
      <td width="74%"><label>
